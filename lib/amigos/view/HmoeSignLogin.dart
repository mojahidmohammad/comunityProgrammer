...
import 'package:chat/amigos/view/login_option.dart';
import 'package:chat/amigos/view/signup.dart';
import 'package:chat/amigos/view/signup_option.dart';
class signLogin extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<signLogin> {
...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    var paint = Paint();
    paint.color = MyColor.Mianyallow;
    ...
    path.quadraticBezierTo(
        size.width * 0.5, outterCurve ? size.height + 110 : size.height - 110,
